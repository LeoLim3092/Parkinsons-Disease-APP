...
class GestureRecordingPageTurningRight extends StatefulWidget {
  List<CameraDescription> cameras;
  Patient patient;

  /// Default Constructor
  GestureRecordingPageTurningRight({Key? key, required this.cameras, required this.patient}) : super(key: key);

  @override
  State<GestureRecordingPageTurningRight> createState() {
    return _GestureRecordingPageTurningRightState();
  }
}
...
class _GestureRecordingPageTurningRightState extends State<GestureRecordingPageTurningRight> with WidgetsBindingObserver, TickerProviderStateMixin {
    ...
    stopVideoRecording().then((XFile? file) {
      ...
      if (file != null) {
        showUploadDialog(
          ...
          dialogTitle: "上傳",
          dialogContent: "請問您是否要上傳此次右手旋轉錄影？",
          cancelText: "取消",
          uploadText: "上傳",
        );
      }
