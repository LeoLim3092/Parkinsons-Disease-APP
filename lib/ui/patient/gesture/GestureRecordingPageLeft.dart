...
class GestureRecordingPageLeft extends StatefulWidget {
  List<CameraDescription> cameras;
  Patient patient;

  /// Default Constructor
  GestureRecordingPageLeft({Key? key, required this.cameras, required this.patient}) : super(key: key);

  @override
  State<GestureRecordingPageLeft> createState() {
    return _GestureRecordingPageLeftState();
  }
}
...
class _GestureRecordingPageLeftState extends State<GestureRecordingPageLeft> with WidgetsBindingObserver, TickerProviderStateMixin {
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                if (response.statusCode == 200) {
                  uploadStatus.setUploadLHStatus(true);
                }
                EasyLoading.dismiss();
